...
ASM_INCLUDES := -I"config" -I"config/btconf" -I"autogen" -I"." -I"$(SDK_PATH)/platform/Device/SiliconLabs/MGM24/Include" -I"$(SDK_PATH)/app/common/util/app_assert" -I"$(SDK_PATH)/protocol/bluetooth/inc" -I"$(SDK_PATH)/platform/common/inc" -I"$(SDK_PATH)/protocol/bluetooth/bgstack/ll/inc" -I"$(SDK_PATH)/hardware/board/inc" -I"$(SDK_PATH)/platform/bootloader" -I"$(SDK_PATH)/platform/bootloader/api" -I"$(SDK_PATH)/platform/CMSIS/Core/Include" -I"$(SDK_PATH)/hardware/driver/configuration_over_swo/inc" -I"$(SDK_PATH)/platform/driver/debug/inc" -I"$(SDK_PATH)/platform/service/device_init/inc" -I"$(SDK_PATH)/platform/emdrv/common/inc" -I"$(SDK_PATH)/platform/emlib/inc" -I"$(SDK_PATH)/platform/radio/rail_lib/plugin/fem_util" -I"$(SDK_PATH)/app/bluetooth/common/gatt_service_device_information" -I"$(SDK_PATH)/platform/service/hfxo_manager/inc" -I"$(SDK_PATH)/app/bluetooth/common/in_place_ota_dfu" -I"$(SDK_PATH)/platform/security/sl_component/sl_mbedtls_support/config" -I"$(SDK_PATH)/platform/security/sl_component/sl_mbedtls_support/config/preset" -I"$(SDK_PATH)/platform/security/sl_component/sl_mbedtls_support/inc" -I"$(SDK_PATH)/util/third_party/mbedtls/include" -I"$(SDK_PATH)/util/third_party/mbedtls/library" -I"$(SDK_PATH)/platform/service/mpu/inc" -I"$(SDK_PATH)/hardware/driver/mx25_flash_shutdown/inc/sl_mx25_flash_shutdown_usart" -I"$(SDK_PATH)/platform/emdrv/nvm3/inc" -I"$(SDK_PATH)/platform/peripheral/inc" -I"$(SDK_PATH)/platform/service/power_manager/inc" -I"$(SDK_PATH)/platform/security/sl_component/sl_psa_driver/inc" -I"$(SDK_PATH)/platform/radio/rail_lib/common" -I"$(SDK_PATH)/platform/radio/rail_lib/protocol/ble" -I"$(SDK_PATH)/platform/radio/rail_lib/protocol/ieee802154" -I"$(SDK_PATH)/platform/radio/rail_lib/protocol/wmbus" -I"$(SDK_PATH)/platform/radio/rail_lib/protocol/zwave" -I"$(SDK_PATH)/platform/radio/rail_lib/chip/efr32/efr32xg2x" -I"$(SDK_PATH)/platform/radio/rail_lib/plugin/pa-conversions" -I"$(SDK_PATH)/platform/radio/rail_lib/plugin/pa-conversions/efr32xg24" -I"$(SDK_PATH)/platform/radio/rail_lib/plugin/rail_util_power_manager_init" -I"$(SDK_PATH)/platform/radio/rail_lib/plugin/rail_util_pti" -I"$(SDK_PATH)/platform/security/sl_component/se_manager/inc" -I"$(SDK_PATH)/platform/security/sl_component/se_manager/src" -I"$(SDK_PATH)/util/silicon_labs/silabs_core/memory_manager" -I"$(SDK_PATH)/platform/common/toolchain/inc" -I"$(SDK_PATH)/platform/service/system/inc" -I"$(SDK_PATH)/platform/service/sleeptimer/inc" -I"$(SDK_PATH)/platform/security/sl_component/sl_protocol_crypto/src" -I"$(SDK_PATH)/platform/service/udelay/inc" 
