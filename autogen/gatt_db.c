...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_27) = {
  .len = 11,
  .data = { 0x62, 0x6c, 0x61, 0x20, 0x62, 0x6c, 0x61, 0x20, 0x62, 0x6c, 0x61, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 10,
  .data = { 0x73, 0x6c, 0x5f, 0x42, 0x47, 0x4d, 0x32, 0x32, 0x30, 0x50, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x0b, .uuid = 0x0003, .permissions = 0x813, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_10 },
  ...
  { .handle = 0x1b, .uuid = 0x000a, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x1c, .uuid = 0x000b, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x00, .constdata = &gattdb_attribute_field_27 },
};
